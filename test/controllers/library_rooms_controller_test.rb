...
class LibraryRoomsControllerTest < ActionController::TestCase
  ...
  test "should create library_room" do
    assert_difference('LibraryRoom.count') do
      post :create, library_room: { booked: @library_room.booked, building: @library_room.building, number: @library_room.number, size: @library_room.size }
    end
  ...
  test "should update library_room" do
    patch :update, id: @library_room, library_room: { booked: @library_room.booked, building: @library_room.building, number: @library_room.number, size: @library_room.size }
    assert_redirected_to library_room_path(assigns(:library_room))
  end
